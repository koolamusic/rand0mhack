      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
          ...
          <h3 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Powered by Aptos Randomnet
          </h3>
          <p className="mt-6 text-base leading-7 text-gray-300">
            Deposit APT. Spin the wheel of luck because You Only Live Once.
            however know that there will only be one winner!!!
          </p>
          <div className="mt-8">
            <a
              href="#"
